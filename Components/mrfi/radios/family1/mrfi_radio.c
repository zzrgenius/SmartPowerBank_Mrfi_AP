...
{
	return MRFI_PAPD_PIN_IS_HIGH(); // MRFI_GDO0_PIN_IS_LOW();// || marc_state == RF_SM_RX || marc_state == RF_SM_IDLE;
}
...
//			 Mrfi_DelayUsec(45000); 
			 ...
			 */
		//	Mrfi_DelayUsec(20000);Mrfi_DelayUsec(20000);
			Sys_delay_ms(10);
...
//				{
//					 
//					Mrfi_DelayUsec(45000);  Mrfi_DelayUsec(45000);
//					Mrfi_DelayUsec(45000);  Mrfi_DelayUsec(45000);
//					Mrfi_DelayUsec(45000);  Mrfi_DelayUsec(45000);
//					Mrfi_DelayUsec(45000);  Mrfi_DelayUsec(45000);
// 
